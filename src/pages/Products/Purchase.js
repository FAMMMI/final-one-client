...
const Purchase = () => {
    ...
    useEffect(() => {
        fetch(`https://stark-oasis-86458.herokuapp.com/products?&id=${id}`, {
            method: 'GET',
            headers: {
                'authorization': `Bearer ${localStorage.getItem('accessToken')}`
            }
    ...
    const url = `https://stark-oasis-86458.herokuapp.com/products?&id=${id}`;
    ...
    const onSubmit = async data => {
        ...
        fetch(`https://stark-oasis-86458.herokuapp.com/products/${id}`, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json',
                authorization: `Bearer ${localStorage.getItem('accessToken')}`
