...
const ManageIndividualOrders = (props) => {
    ...
    const changeStatus = () => {
        ...
        fetch(`https://stark-oasis-86458.herokuapp.com/orders?id=${_id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <tr>
            ...
            <td>
                <label onClick={() => setDeleteOrders(props.order)} for="my-modal-6" class="btn btn-xs btn-error">Delete</label>
            </td>
